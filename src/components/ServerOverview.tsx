...
export default function ServerOverview({
  ...
  const [disableAnimatedMan, setDisableAnimatedMan] = useState(false);

  // 在组件加载时读取 window.DisableAnimatedMan
  useEffect(() => {
    if (window.DisableAnimatedMan === "true") {
      setDisableAnimatedMan(true);
    }
  }, []);
